      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {proofs.map((p, i) => (
            ...
            >
              <img src={mediaUrl(p.imageUrl)} alt={p.caption || 'Order proof'} loading="lazy" decoding="async" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
        ...
        {open !== null && (
          ...
          >
            ...
            <motion.img
              ...
              src={mediaUrl(proofs[open].imageUrl)}
